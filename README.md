...
- **About you** and **learned preferences** on the Rules page belong to one
  mailbox each and are sent with that mailbox's batches. A work address and a
  personal one never share a profile, and neither learns from the other's
  corrections.
